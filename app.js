var arr = [
  {
    dp: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=764&q=80",
    story:
...
document.getElementById("stories").addEventListener("click", function (dets) {
  ...
  document
    .querySelector("#fs img")
    .setAttribute("src", arr[dets.target.id].story);
